...
const App = () => {
  ...
  const [trendingMovies, setTrendingMovies] = useState([
    { $id: '1', title: 'Sample Trending Movie', poster_url: 'https://via.placeholder.com/100' }
  ]);
          ...
          <section className="trending">
            ...
            <ul>
              {trendingMovies.map((movie, index) => (
                <li key={movie.$id}>
                  <p>{index + 1}</p>
                  const fallbackImage = "https://dummyimage.com/100x150/000/fff";
                <img src={movie.poster_url || fallbackImage} alt={movie.title} />
